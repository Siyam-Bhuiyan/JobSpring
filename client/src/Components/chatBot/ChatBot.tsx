...
const ChatBot = () => {
  ...
  return (
    <div className="p-10 flex justify-center items-end">
    <div className=" bottom-16 right-10center shadow-xl rounded-2xl overflow-hidden bg-mine-shaft-900 text-white w-2/5 border border-mine-shaft-700">
      {/* Header */}
      ...
      <div className="flex-1 p-4 overflow-y-auto space-y-3 h-96">
        {messages.map((msg, i) => (
          <motion.div
            ...
            className={`max-w-[40%] p-3 rounded-lg ${
              msg.sender === "user"
